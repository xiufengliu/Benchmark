...
CREATE TABLE smas_threel_results(result string);

INSERT OVERWRITE TABLE smas_threel_results SELECT threel(meterid, reading, temperature)  FROM tbl_firstformat;
