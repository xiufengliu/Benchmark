...
@Description(name = "UDAFHistogram", value = "_FUNC_(reading) - ")
public class UDAFHistogram extends UDAF {
    static final Log LOG = LogFactory.getLog(UDAFHistogram.class.getName());
